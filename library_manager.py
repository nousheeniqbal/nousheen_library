...
#adding books input form
    with st.form(key='add_book_form'):
        ...
        with col2:
            genre = st.selectbox("Genre", [
              "Friction", "Non-Friction", "Science", "Technology", "Fantacy", "Poetry", "Self-help", "Art", "Religion", "History"
            ])
    ...
    if not st.session_state.library:
         st.markdown("<div class='warning-message'>Your library is empty. Please add books to get started.</div>", unsafe_allow_html=True)
    else:
        cols = st.columns(2)
...
st.markdown("---")
st.markdown("Copyright @2025 Nousheen Iqbal Personal Library manager", unsafe_allow_html=True)
